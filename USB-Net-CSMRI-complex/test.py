...
def main(test_name, args):
    ...
    if 'brain' in test_name:
        test_dir = f"D:/dataset/mri/brain_test"
    elif 'card' in test_name:
        test_dir = f"D:/dataset/mri/card_test"
    else:
        test_dir = f"D:/dataset/mri/fastmri/fastmri_test/"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cs_ratio', type=int, default=10, help='set sensing rate')
    ...
    # for test_name in ["brain"]:
    for test_name in ["card"]:
        main(test_name, parser)

    # parser.add_argument('--mask_type', type=str, default='Cartesian', help='mask type (default: Radial)')
    # parser.add_argument('--input_size', type=int, default=320, help='input size (default: 256)')
    # for test_name in ["fastmri"]:
    #     main(test_name, parser)
