...
def get_args_parser():
    ...
    parser.add_argument('--input_size', default=32*3, type=int,
                        help='image  size')
    ...
    # Dataset parameters
    parser.add_argument(
        '--data_path', type=str, help='dataset path')
...
def main(args):
    ...
    # checkpoint = torch.load("./model/checkpoint-usbnet-25-best.pth")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'FCMAE fine-tuning', parents=[get_args_parser()])
